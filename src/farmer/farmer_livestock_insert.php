...
<body class="!bg-[#171615]">
    <a id="dashboardBtn" href="farmer_livestock.php"
        class="hover:!bg-[#367723]  text-white !bg-[#3c8527] !border-t-5 !border-b-5 !border-t-[#52a535] !border-b-[#2a641c] !rounded-none">Back</a>
    <div class="container">
        <h2 class="text-white">เพิ่มรายการปศุสัตว์</h2>
        <div
            ...
            <form action="farmer_livestock_insert.php" method="post" enctype="multipart/form-data">
                ...
                <input
                    ...
                    type="text" id="tag_number" name="tag_number" required>
                ...
                <div class="grid grid-2">
                    <div>
                        ...
                        <input
                            class=" !border-[#313232] !rounded-none !focus:outline-2 !focus:outline-offset-2 !focus:outline-violet-500 active:bg-violet-700 !bg-[#0e0d0d] !text-[#ede5e2]"
                            type="text" id="breed" name="breed" placeholder="ตัวอย่าง: Angus / Boer / Leghorn">
                    </div>
                    <div>
                        <label for="weight">น้ำหนัก (กก.)</label>
                        <input
                            class=" !border-[#313232] !rounded-none !focus:outline-2 !focus:outline-offset-2 !focus:outline-violet-500 active:bg-violet-700 !bg-[#0e0d0d] !text-[#ede5e2]"
                            type="number" step="0.01" id="weight" name="weight" placeholder="เช่น 580.5">
                    </div>
                </div>
                ...
                <div class="grid grid-2">
                    <div>
                        ...
                        <input
                            class=" !border-[#313232] !rounded-none !focus:outline-2 !focus:outline-offset-2 !focus:outline-violet-500 active:bg-violet-700 !bg-[#0e0d0d] !text-[#ede5e2]"
                            type="url" id="image_url" name="image_url" placeholder="https://example.com/image.jpg">
                ...
                <div class="preview  !border !border-[#313232] !border-[#313232] !rounded-none !focus:outline-2 !focus:outline-offset-2 !focus:outline-violet-500 active:bg-violet-700 !bg-[#0e0d0d] !text-[#ede5e2]"
                    id="imagePreview">Preview</div>

                <button
                    class="hover:!bg-[#367723]  text-white !bg-[#3c8527] !border-t-5 !border-b-5 !border-t-[#52a535] !border-b-[#2a641c] !rounded-none"
                    type="submit">เพิ่มรายการ</button>
            </form>
        </div>
    </div>
