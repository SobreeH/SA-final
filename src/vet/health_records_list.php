...
<body class="!bg-[#171615]">
    <div class="container">
        <h2 class="text-white">Health Records</h2>
        <div class="mb-3 d-flex justify-content-end !gap-4">
            ...
            <div>
                <button
                    ...
                    data-bs-toggle="modal" data-bs-target="#addHealthModal">+ Add Health Record</button>
            </div>
        </div>
            ...
            <table
                ...
                <thead class="!bg-[#312f2e] !text-[#ede5e2]"
                    ...
                    <tr>
                        ...
                        <th style="color: #ede5e2 !important; border-color: #272626 !important;">Treatment Date</th>
                        <th style="color: #ede5e2 !important; border-color: #272626 !important;">Treatment</th>
                    </tr>
                </thead>
                <tbody class="!bg-[#0e0d0d]" style="background-color: #0e0d0d !important;">
                    ...
                    <tr class="!bg-[#0e0d0d] !text-[#ede5e2]"
                        ...
                        <td style="border-color: #272626 !important; color: #ede5e2 !important;">
                            <?= ucfirst($row['type']) ?></td>
                        <td style="border-color: #272626 !important; color: #ede5e2 !important;">
                            <?= $row['treatment_date'] ?></td>
                        <td style="border-color: #272626 !important; color: #ede5e2 !important;">
                            <?= htmlspecialchars($row['treatment']) ?></td>
                    </tr>
                    <?php endwhile; ?>
                    <?php else: ?>
                    <tr class="!bg-[#0e0d0d] !text-[#ede5e2]"
                        ...
                        <td colspan="5" class="text-center"
                            style="border-color: #272626 !important; color: #ede5e2 !important;">No health records found
                        </td>
                    </tr>
                    <?php endif; ?>
                </tbody>
    ...
    <div class="modal fade dark-modal" id="addHealthModal" tabindex="-1" aria-labelledby="addHealthModalLabel"
        aria-hidden="true">
    ...
    while($row = $livestock_list->fetch_assoc()): ?>
                        ...
                        <div class="mb-3">
                            <label class="dark-label">Treatment</label>
                    ...
                    <div class="modal-footer">
                        <button type="submit" name="add_health"
